...
import com.example.gitsearch.databinding.ItemErrorBinding
import com.example.gitsearch.databinding.ItemProgressBinding

class FirstFragmentLoaderStateAdapter :
    LoadStateAdapter<FirstFragmentLoaderStateAdapter.ItemViewHolder>() {
    ...
    class ErrorViewHolder internal constructor(
        ...
        companion object {
            ...
            operator fun invoke(
                layoutInflater: LayoutInflater, parent: ViewGroup? = null,
                attachToRoot: Boolean = false
            ): ErrorViewHolder {
